...
if ($_POST) {
    ...
    if ($_FILES["resim1"]['name']) {
        ...
        if (move_uploaded_file($_FILES["$posted"]['tmp_name'], "resimler/" . $yeniad)) {
            $insert = $db->exec("INSERT INTO bakliyatde SET  bakliyat_url='{$hedef1}',bakliyat_p=0, bakliyat_title='{$bakliyat_title}'");
            //$insert->execute();
...
<section class="section">
    <div class="section-inner">
        ...
        <h2 class="heading"><i class="fa fa-plus"></i> Bakliyat DE<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=bakliyatde"; ?>"><i class="fa fa-file-text-o"></i> İçerikleri Göster </a></small></h2>
