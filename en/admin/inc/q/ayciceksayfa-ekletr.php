...
if ($_POST) {
    ...
    if ($_FILES["resim1"]['name']) {
        ...
        if (move_uploaded_file($_FILES["$posted"]['tmp_name'], "resimler/" . $yeniad)) {
            $insert = $db->exec("INSERT INTO ayciceksayfatr SET  aycicegiyag_url='{$hedef1}', aycicegiyag_title='{$Konala_title}', aycicegiyag_text='{$Konala_text}'");
            //$insert->execute();
            echo "<p class='alert alert-success'>İçerik başarıyla eklendi. Lütfen Bekleyiniz...</p>";
            header("Refresh: 0; url=" . URL . "/en/admin/index.php?do=ayciceksayfatr");
        } else {
...
<section class="section">
    <div class="section-inner">
        ...
        <h2 class="heading"><i class="fa fa-plus"></i>Ayçiçek Tağı Sayfa TR<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=ayciceksayfatr"; ?>"><i class="fa fa-file-text-o"></i> İçerikleri Göster </a></small></h2>
