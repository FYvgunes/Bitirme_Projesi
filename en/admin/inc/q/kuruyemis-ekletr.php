...
if ($_POST) {
    ...
    if ($_FILES["resim1"]['name']) {
        ...
        if (move_uploaded_file($_FILES["$posted"]['tmp_name'], "resimler/" . $yeniad)) {
            $insert = $db->exec("INSERT INTO kuruyemistr SET  kuruyemis_url='{$hedef1}',kuruyemis_p=0, kuruyemis_text='{$Konala_text}'");
            //$insert->execute();
            echo "<p class='alert alert-success'>İçerik başarıyla eklendi. Lütfen Bekleyiniz...</p>";
            header("Refresh: 0; url=" . URL . "/en/admin/index.php?do=kuruyemistr");
        } else {
...
<section class="section">
    <div class="section-inner">
        ...
        <h2 class="heading"><i class="fa fa-plus"></i> Kuruyemiş TR<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=kuruyemistr"; ?>"><i class="fa fa-file-text-o"></i> İçerikleri Göster </a></small></h2>
        ...
        <div class="item row">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <label>İçerik: </label><textarea name="kuruyemis_text"></textarea>
                <script>
