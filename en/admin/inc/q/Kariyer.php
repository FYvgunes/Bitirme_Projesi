...
<section class="section">
	...
	<h2 class="heading"><i class="fa fa-newspaper-o"></i> Kariyer<br/><small><a href="<?php echo URL."/en/admin/index.php?do=Kariyer-ekle"; ?>"><i class="fa fa-plus"></i> Pozisyon Ekle</a></small></h2>
		<div class="item row">
<?php
$sorgu = $db->query("SELECT Kariyer_id FROM kariyer", PDO::FETCH_ASSOC);
...
$row = $db->query("SELECT * FROM  kariyer  ORDER BY Kariyer_id DESC LIMIT $baslangic, $limit", PDO::FETCH_ASSOC);
foreach($row as $Kariyer){
	...
	<div class="list-group-item list-trend">
        ...
        <small>| <a href="<?php echo URL."/en/admin/index.php?do=Kariyer-duzenle&id=".$Kariyer['Kariyer_id']; ?>"><i class="fa fa-edit"></i> Düzenle</a> | <a  onclick="return confirm('Pozisyonu silmek istediğinizden emin misiniz?');" href="<?php echo URL."/en/admin/index.php?do=Kariyer-sil&id=".$Kariyer['Kariyer_id']; ?>"><i class="fa fa-trash-o"></i> Sil</a></small>
