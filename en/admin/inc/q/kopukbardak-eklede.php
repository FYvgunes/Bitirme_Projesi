...
if ($_POST) {
    ...
    if ($_FILES["resim1"]['name']) {
        ...
        if (move_uploaded_file($_FILES["$posted"]['tmp_name'], "resimler/" . $yeniad)) {
            $insert = $db->exec("INSERT INTO kopukbardakde SET  kopukbardak_url='{$hedef1}',kopukbardak_p=0, kopukbardak_title='{$Konala_text}'");
            //$insert->execute();
...
<section class="section">
    <div class="section-inner">
        ...
        <h2 class="heading"><i class="fa fa-plus"></i> Köpük Bardak DE<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=kopukbardakde"; ?>"><i class="fa fa-file-text-o"></i> İçerikleri Göster </a></small></h2>
