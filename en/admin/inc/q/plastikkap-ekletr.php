...
if ($_POST) {
    ...
    if ($_FILES["resim1"]['name']) {
        ...
        if (move_uploaded_file($_FILES["$posted"]['tmp_name'], "resimler/" . $yeniad)) {
            $insert = $db->exec("INSERT INTO plastikkaptr SET  plastikkap_url='{$hedef1}',plastikkap_p=0, plastikkap_title='{$Konala_text}'");
            //$insert->execute();
...
<section class="section">
    <div class="section-inner">
        ...
        <h2 class="heading"><i class="fa fa-plus"></i> Plastik Kap TR<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=plastikkaptr"; ?>"><i class="fa fa-file-text-o"></i> İçerikleri Göster </a></small></h2>
