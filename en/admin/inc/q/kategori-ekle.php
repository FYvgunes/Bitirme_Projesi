...
if ($_POST) {
    ...
    if (empty($category_title)) {
        ...
        $sorgu = $db->prepare("SELECT COUNT(*) FROM categories WHERE category_url='{$category_url}'");
        $sorgu->execute();
        ...
        if ($say > 0) {
            ...
            $insert = $db->prepare("INSERT INTO categoriesen SET category_title='{$category_title}', category_url='{$category_url}', category_menu='{$category_menu}', category_onoff=1");
            $insert->execute();
...
<section class="section">
    <div class="section-inner">
        <h2 class="heading"><i class="fa fa-plus"></i> Kategori Ekle EN<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=kategori"; ?>"><i class="fa fa-folder"></i> Kategorileri Göster</a></small></h2>
        <div class="item row">
