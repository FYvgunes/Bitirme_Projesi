...
if ($_POST) {
    ...
    if ($_FILES["resim1"]['name']) {
        ...
        if (move_uploaded_file($_FILES["$posted"]['tmp_name'], "resimler/" . $yeniad)) {
            $insert = $db->exec("INSERT INTO peynirde SET  peynir_url='{$hedef1}',peynir_p=0, peynirler_text='{$Konala_text}'");
            //$insert->execute();
...
<section class="section">
    <div class="section-inner">
        ...
        <h2 class="heading"><i class="fa fa-plus"></i> Peynirler DE<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=peynirde"; ?>"><i class="fa fa-file-text-o"></i> İçerikleri Göster </a></small></h2>
        ...
        <div class="item row">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <label>İçerik: </label><textarea name="peynirler_text"></textarea>
                <script>
