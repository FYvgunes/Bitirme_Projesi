...
if ($_POST) {
    ...
    if ($_FILES["resim1"]['name']) {
        ...
        if (move_uploaded_file($_FILES["$posted"]['tmp_name'], "resimler/" . $yeniad)) {
            $insert = $db->exec("INSERT INTO donukdenizde SET  donukdeniz_url='{$hedef1}',donukdeniz_p=0, donukdeniz_text='{$Konala_text}'");
            //$insert->execute();
            echo "<p class='alert alert-success'>İçerik başarıyla eklendi. Lütfen Bekleyiniz...</p>";
            header("Refresh: 2; url=" . URL . "/en/admin/index.php?do=donukdenizde");
        } else {
...
<section class="section">
    <div class="section-inner">
        ...
        <h2 class="heading"><i class="fa fa-plus"></i> Donuk Deniz Ürünleri DE<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=donukdenizde"; ?>"><i class="fa fa-file-text-o"></i> İçerikleri Göster </a></small></h2>
