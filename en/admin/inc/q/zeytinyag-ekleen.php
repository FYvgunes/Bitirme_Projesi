...
if ($_POST) {
    ...
    if ($_FILES["resim1"]['name']) {
        ...
        $isim = md5(microtime());
        $yeniad = "" . $isim . "." . $uzanti . "zeytinyagi";
        if (!file_exists("resimler")) {
            mkdir("resimler");
        }
        $hedef1 = "resimler/" . $yeniad;
        if (move_uploaded_file($_FILES["$posted"]['tmp_name'], "resimler/" . $yeniad)) {
            $insert = $db->exec("INSERT INTO zeytinyagen SET  zeytinyag_url='{$hedef1}',zeytinyag_p=0, zeytinyag_text='{$Konala_text}'");
            //$insert->execute();
...
<section class="section">
    <div class="section-inner">
        ...
        <h2 class="heading"><i class="fa fa-plus"></i> Zeytin Yağ EN<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=zeytinyagen"; ?>"><i class="fa fa-file-text-o"></i> İçerikleri Göster </a></small></h2>
