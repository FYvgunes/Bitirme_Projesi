...
if ($_POST) {
    ...
    if ($_FILES["resim1"]['name']) {
        ...
        if (move_uploaded_file($_FILES["$posted"]['tmp_name'], "resimler/" . $yeniad)) {
            $insert = $db->exec("INSERT INTO aycicegiyagtr SET  aycicegiyag_url='{$hedef1}',aycicegiyag_p=0, aycicegiyag_text='{$aycicegiyag_text}'");
            //$insert->execute();
...
<section class="section">
    <div class="section-inner">
        ...
        <h2 class="heading"><i class="fa fa-plus"></i> Ayçicek Yağı TR<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=Kanola-yagitr"; ?>"><i class="fa fa-file-text-o"></i> İçerikleri Göster </a></small></h2>
